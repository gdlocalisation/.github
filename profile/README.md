...
- [__@raelc__](https://github.com/NotRaelc) - переводчик игры, помощник с инсталлятором.

Отдельное спасибо нескольким людям - [__HJfod__](https://github.com/HJfod), [__Mat__](https://github.com/matcool/), [__QuasarKim__](https://github.com/Quasar-Kim   ), [__sleepyut__](http://steamcommunity.com/profiles/76561199402960601).

## Установка 
#### Windows (7, 8, 8.1, 10, 11):
1. Скачайте [установщик](https://github.com/gdlocalisation/gdl-installer/releases/latest/download/GDL_Installer.exe).
2. Откройте его (Нужно немного подождать, он берёт информацию с сервера) и начните установку. <br />![Screenshot1](screenshots/1.png)
...
5. Нажмите установить. <br />![Screenshot4](screenshots/4.png)
...
5. Поддержка андроид ✔️
6. Трейлер для канала ✔️

# <font size="7">__2.2__<font size="3">
## <u>__После выхода 2.2 мод частично стал нерабочим. На данный момент мы переводим все тексты игры (их ОЧЕНЬ МНОГО) и делаем порт на новую версию игры. Пожалуйста, подождите пока мы не сделаем мод полностью.__</u>
